...
const SignUp = () => {
  ...
  const addClient = () => {
    ...
    const { isInvalid, errors } = ClientValidation(newClient);
    ...
    if (isInvalid) {
      ...
      setErrors(errors);
      axios
        .post('http://localhost:8000/api/client/', newClient)
        .then((response) => {
  ...
  const checkLogin = () => {
    ...
    axios
      .post('http://localhost:8000/api/client/login/', chekLogin)
      .then((response) => {
    ...
    <div className="container" id="container">
      ...
      >
        <form className="signUpForm form" style={{ height: 'auto' }}>
          <h1 className="h1" style={{ 'margin-top': '50px' }}>
            Create Account
          </h1>
          <span className="span mb-3 mt-4">
          ...
          <div className="row">
            <div className="col-12">
              ...
              <small
                id="client_Password"
                className="d-block text-danger text-start form-text invalid-feedback"
              >
          ...
          <button
            type="button"
            className="btn button mt-5 mb-5"
            onClick={() => {
              addClient();
            }}
          >
      ...
      <div className="form-container sign-in-container">
        <form className="loginForm form">
          ...
          />
          <a className="a" style={{ cursor: 'pointer' }}>
      ...
      <div className="overlay-container">
        <div className="overlay">
          ...
          <div className="overlay-panel overlay-right">
            ...
            <button className="ghost btn button" id="signUp">
              Sign Up
            </button>
          </div>
        </div>
